    ...
    hotelsInfo: [
      {
        ...
        rooms: [
          { floor: 1, number: 11, image: LuxuryRoom11, persons: 4, price: 2400, occupied: [] },
          { floor: 1, number: 12, image: LuxuryRoom12, persons: 3, price: 2000, occupied: [] },
          { floor: 1, number: 13, image: LuxuryRoom13, persons: 2, price: 2200, occupied: [] },
          { floor: 1, number: 14, image: LuxuryRoom14, persons: 2, price: 2200, occupied: [] },
          { floor: 2, number: 21, image: LuxuryRoom21, persons: 2, price: 2000, occupied: [] },
          { floor: 2, number: 22, image: LuxuryRoom22, persons: 2, price: 2000, occupied: [] },
          { floor: 2, number: 23, image: LuxuryRoom23, persons: 2, price: 2500, occupied: [] },
        ],
        images: {
      ...
      },
      {
        ...
        rooms: [
          { floor: 1, number: 11, image: IndependenceRoom11, persons: 3, price: 1900, occupied: [] },
          { floor: 1, number: 12, image: IndependenceRoom12, persons: 3, price: 1900, occupied: [] },
          { floor: 1, number: 13, image: IndependenceRoom13, persons: 2, price: 1600, occupied: [] },
          { floor: 1, number: 14, image: IndependenceRoom14, persons: 2, price: 1700, occupied: [] },
        ],
        images: {
    ...
    hotelsInfo: [
      {
        ...
        rooms: [
          { floor: 1, number: 11, image: Code10Room11, persons: 4, price: 2400, occupied: [] },
          { floor: 1, number: 12, image: Code10Room12, persons: 2, price: 2000, occupied: [] },
          { floor: 2, number: 21, image: Code10Room21, persons: 3, price: 2100, occupied: [] },
          { floor: 2, number: 22, image: Code10Room22, persons: 2, price: 2000, occupied: [] },
          { floor: 3, number: 31, image: Code10Room31, persons: 2, price: 2000, occupied: [] },
          { floor: 3, number: 32, image: Code10Room32, persons: 2, price: 2000, occupied: [] },
        ],
        images: {
