    ...
    hotelsInfo: [
      {
        ...
        conveniences: [
          "Convenient location",
          "Car parking",
          "Comfortable beds and pillows with snow-white linen",
          "Green area",
      ...
      },
      {
        ...
        conveniences: [
          ...
          "Near iconic sights",
          "Cosy rooms",
          "2 restaurants and ordering food to the room",
          "The common area has a full kitchen, a washing machine, an iron, in general, everything is like home.",
          "up to 24 people",
        ],
